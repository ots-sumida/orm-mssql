...
`modules/config/config.js` から export を追加します。
...
```javascript
import { createConnectionManager } from './modules/db/db.js';
import { extractDbConfigFromKeyVault } from './modules/config/config.js';
