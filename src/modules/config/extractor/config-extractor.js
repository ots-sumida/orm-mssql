...
const { loadDbConfigFromEnv } = require('../providers/env-config-provider');
/**
 ...
 */
function extractDbConfigFromEnv(env = process.env) {
 ...
 */
async function extractDbConfigFromKeyVault(_options) {
  throw new Error('Key Vault からの設定取得は未実装です。providers/keyvault-config-provider.js を追加してください。');
}

module.exports = {
  extractDbConfigFromEnv,
  extractDbConfigFromKeyVault,
};
